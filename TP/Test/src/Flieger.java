...
public class Flieger implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Flieger " + name + " ist gestartet");
        try {
            Thread.sleep(new Random().nextInt(1000, 2000));
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
        System.out.println("Flieger" + name + " beginnt Landeanflug");
        try {
            System.out.println("Flieger " + name + " wartet auf Bahn");
            ...
            if (willCrash) {
                System.out.println("Flieger " + name + " ist abgestürzt auf Bahn");
                ...
                System.out.println("Flieger "+ name + " ist gelandet auf Bahn");
                tower.getBahnen().release();
                countDownLatch.countDown();
            }
        }
